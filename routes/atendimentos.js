...
app.post("/insert", async(req,res)=>{
    const insert = "INSERT INTO atendimentos (nome,datachamado,status_atendimento,descricao,id_cliente) VALUES (?,?,?,?,?)";
...
app.put("/insert/:id", async(req,res)=>{
    const update = "UPDATE atendimentos SET nome = ?,datachamado = ?,status_atendimento = ? ,descricao = ?, id_cliente = ? WHERE id=?";
    const {nome,datachamado,status_atendimento,descricao,id_cliente} = req.body;
    try{
